...
D009=RequestProcureCropList:h(subID)d(ListCount:For.0004)d(ObjectID)d(ItemID)d(Ãîðîä)d(ItemCount)
...
FE22=ManorList2:h(subID)d(ItemID)d(ListCount:For.004)d(Ãîðîä)d(Count)d(Price)c(c)
